...
- **Context Menu Integration**: Right-click on `.xlf` or `.xliff` files to open the editor
...
None at the moment. Please report issues on the [GitHub repository](https://github.com/your-username/nyarcode-xlf-editor/issues).
